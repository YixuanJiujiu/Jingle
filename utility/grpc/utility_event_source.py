...
from Jingle.utility.grpc.protogen import utility_update_pb2_grpc
from Jingle.utility.grpc.protogen import utility_update_pb2
from Jingle.utility.events import UtilityUpdateEvent
...
class UtilityMessagingServicer(utility_update_pb2_grpc.UtilityMessagingServicer):
    ...
    def PublishUtility(self,
        ...
        if self.debug_mode:
            logger.info(f"------------------- GRPC Server Got event: {str(event)} ----------------")
