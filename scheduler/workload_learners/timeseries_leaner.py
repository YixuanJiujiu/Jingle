...
import logging
# Local
from Jingle.scheduler.workload_learners.workload_learner_bank import TSForecaster

logger = logging.getLogger(__name__)

DFLT_SLEEP_TIME_BETWEEN_DATA_REPOLaLS = 0.0
...
class TSBaseLearner(TSForecaster):
    ...
    def _get_arima_model(self, model_descr):
        ...
        from scheduler.workload_learners.arima_learner import ARIMATSModel
