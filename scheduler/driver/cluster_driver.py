...
"""
    Main driver to run autoscaling algorithms
...
from Jingle.scheduler.core.base_performance_recorder import BasePerformanceRecorder, BasePerformanceRecorderBank
...
from Jingle.scheduler.allocation_policies.autoscaling import LearnAutoScaler
from Jingle.scheduler.allocation_policies.as_baselines import K8sAutoScaler, PIDAutoScaler, DS2AutoScaler
...
def main():
    ...
    for leaf_path, leaf in env.leaf_nodes.items():
        ...
        data_logger = DataLogger(
            leaf_path, ['load', 'DEBUG.avg_latency', 'DEBUG.p99', 'DEBUG.stddev_latency',
    ...
    if args.policy == 'aslearn':
        policy = LearnAutoScaler(
